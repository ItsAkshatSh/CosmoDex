(function() {
    ...
    const sounds = {
        ...
        correct: () => {
            ...
            setTimeout(() => createBeep(659, 0.2, 'sine'), 100); 
            setTimeout(() => createBeep(784, 0.3, 'sine'), 200); 
            createSuccessVisual();
        },
        incorrect: () => {
        ...
        complete: () => {
            ...
            setTimeout(() => createBeep(784, 0.2, 'sine'), 300);
            setTimeout(() => createBeep(1047, 0.4, 'sine'), 450);
            createConfetti();
        },
        levelUp: () => {
            createBeep(523, 0.2, 'sine'); 
            setTimeout(() => createBeep(659, 0.2, 'sine'), 100); 
            setTimeout(() => createBeep(784, 0.2, 'sine'), 200); 
            setTimeout(() => createBeep(1047, 0.2, 'sine'), 300); 
            setTimeout(() => createBeep(1319, 0.4, 'sine'), 400); 
        },
